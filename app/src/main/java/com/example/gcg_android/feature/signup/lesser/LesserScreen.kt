package com.example.gcg_android.feature.signup.lesser
...
fun LesserScreen(
    ...
    Box(
        ...
        Column(
            ...
            InputField(label = "아이디", text = idText, onTextChange = { idText = it })
            InputField(label = "비밀번호", text = pwText, onTextChange = { pwText = it })
            InputField(label = "전화번호", text = tellText, onTextChange = { tellText = it })
            InputField(label = "이름", text = name, onTextChange = { name = it })
            InputField(label = "호수", text = registerNumber, onTextChange = { registerNumber = it })
